...
import static com.framgia.music5.BaseColumsDatabase.DATABASE_NAME;
import static com.framgia.music5.BaseColumsDatabase.DATABASE_VERSION;
import static com.framgia.music5.BaseColumsDatabase.ID;
import static com.framgia.music5.data.local.ContractSong.DatabaseAlbum.SQL_CREATE_TABLE_ALBUM;
import static com.framgia.music5.data.local.ContractSong.DatabaseAlbum.SQL_DELTE_ALBUM;
import static com.framgia.music5.data.local.ContractSong.DatabaseFavorite.SQL_CREATE_TABLE_FAVORITE;
import static com.framgia.music5.data.local.ContractSong.DatabaseFavorite.SQL_DELTE_FAVORITE;
import static com.framgia.music5.data.local.ContractSong.DatabaseSongDeleted
        .SQL_CREATE_TABLE_SONGDELETED;
import static com.framgia.music5.data.local.ContractSong.DatabaseSongDeleted.SQL_DELTE_SONGDELETED;
import static com.framgia.music5.data.local.ContractSong.DatabaseSongDeleted.TABLE_SONG_DELETED;
import static com.framgia.music5.data.local.ContractSong.DatabaseSongInAlbum
        .SQL_CREATE_TABLE_SONG_IN_ALBUM;
import static com.framgia.music5.data.local.ContractSong.DatabaseSongInAlbum
        .SQL_DELTE_SONG_IN_ALBUM;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    protected List<Song> getSongsFromMediaStore() {
        String[] projection = {
        ...
        if (cursor.moveToFirst()) {
            while (!cursor.isAfterLast()) {
                ...
                Song song = new Song(id, title, singer, data, duration);
                songs.add(song);
                cursor.moveToNext();
            }
            cursor.close();
